...
results_adam=joblib.load("results/results_batchtest/results_values/Adam_results_batch128_lr0.0003425316690148133.pkl")
results_dg =joblib.load("results/results_batchtest/results_values/DeltaGrad_results_batch128_lr0.10088051249528875.pkl")
